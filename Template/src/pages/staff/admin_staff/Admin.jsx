      ...
      {buttonToggle ? (
        ...
        <div className="add-staff">
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
            <button className={custom.global_btn} onClick={open}>+Add Admin</button>
            ...
            <Table sx={{ minWidth: 650 }} aria-label="Department Table">
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>Ravi Kishan Pandey</TableCell>
                  <TableCell>8767890763</TableCell>
                  <TableCell>ravi59@gmail.com</TableCell>
                  <TableCell>
